"""
Build submission_bundle_v4/ — restructured around audience-care questions.

What changed since v3:
  - Option B docx rebuilt from manuscript v12 (audience-pull restructure:
    "What surprised me / What's changing / What we can feel proud of /
    Where we are stretched / Who is missing / Paths through the meeting /
    What future organisers might take away"). Subtitle: "If this program
    is a mirror, what does it show we are becoming?"
  - Option A docx rebuilt from short-form v4 mirroring the same structure
    at the 900-word scale.
  - Watershed hero image preserved at the top of both.
  - Data figures (disciplinary chart, freshwater chart) preserved.
  - Inquiry email v10 reframed to lead with the mirror question and the
    "what surprised me" finding.
  - README updated.

Outputs:
  G:\...\_ConferenceLandscape\submission_bundle_v4\
  G:\...\submission_package\Freeman_MeetingHighlights_ASLO-SIL_2026_v5.docx
  G:\...\submission_package\Freeman_OptionB_LongForm_v13.docx
  G:\...\submission_package\presubmission_inquiry_email_v10.txt
"""
...
BUNDLE = CONFLAND / "submission_bundle_v4"
...
if not WS_ARCHIVE_PNG.exists():
    raise SystemExit("Watershed PNG missing — run bundle v3 builder first.")

# Downsampled copy for embedding
...
# ===========================================================================
# OPTION B — Bulletin Article candidate (manuscript v12 long form)
# ===========================================================================
docB = Document()
...
p_text(docB, "The most visible method backbone is not AI. It is long-term monitoring. Long-term monitoring and time-series sit at about 9% of talks — the most-tagged single method in the program — and they thread through about ten distinct problem clusters, from lakes and microbial ecology to climate, biogeochemistry, biodiversity, conservation, eutrophication, and the cryosphere. AI and machine learning are present (about 2.4%) but spread thin: visible across many problem areas, but at low intensity in each. The story the program tells is not \"AI is changing the field.\" It is \"patient, multi-decade observation is the connective tissue that holds the field together — and AI is being adopted on top of it.\"")
p_text(docB, "Equity content is not in a silo. Indigenous-knowledge, equity, community-led, and citizen-science framings appear in 58 talks across 14 session items, about 4% of the program. That share is small, but the topological role is large: in a co-occurrence network of the program's tags, Indigenous knowledge and equity sit alongside rivers, estuaries, fisheries, food webs, and DOM chemistry as bridge topics — they connect otherwise-distinct sub-conversations. EP013 \"Two-Eyed Seeing: Indigenous Knowledge and Western Science\" is programmed as a science session, not an adjunct. WS05 and WS08 are dedicated workshops. SS079 treats participatory science as a methods session. The equity content is not happening next to the program; it is routing through it.")
p_text(docB, "Lakes are the connective vertebrae of the program's intellectual spine. The strongest co-attentions in the program pair lakes with microbial ecology, climate change, long-term monitoring, and biogeochemistry. Lakes appear in four of the five strongest tag-pairs. In a joint ASLO–SIL meeting it is easy to read freshwater dominance as \"limnology won this round.\" It is more interesting to read it as \"lakes are the system through which most of the other questions get asked.\"")
...
p_text(docB, "Forecasting and monitoring on the same shelf. SS070 \"Exploring the Confluence of Data, Models, and Forecasts for Advancing Adaptive Management\" puts long-term observation, mechanistic modelling, and forward prediction in one room. The program is treating prediction as part of the science, not as a translation layer that happens after it.")

# What we can feel proud of
docB.add_heading("What we can feel proud of", level=2)
p_text(docB, "The community has, quietly, reached a gender-balance signal at both presenter and organiser levels. Among presenter names a public-domain database could classify, about 53% are female-inferred; among session organisers, about 56%. The classifier is European-biased and left about 12% of names unclassified, so this should be read as a rough signal rather than a census of gender identity. Within those limits, ASLO-SIL 2026 looks close to balance — a place much of STEM has not reached.")
...
p_text(docB, "This is abundance, and it is also stretched cognition. The program contains more conversations than any single brain can follow in real time, and pretending otherwise is part of how meetings exhaust the people who go to them. Treat the density as a feature: pick three sessions, attend them properly, and let the meeting continue after the meeting.")

# Who is missing
docB.add_heading("Who is missing, and how we invite them in", level=2)
p_text(docB, "The geography of participation points to one of the field's clearest opportunities. The US accounts for about 29% of country-detected presentations, Canada about 25%; together they are about 54% of the program.")
...
# What organisers might take away
docB.add_heading("What future organisers might take away", level=2)
p_text(docB, "A few signals from the program data, offered as honestly as I can manage:")
p_text(docB, "The early-career scaffold is a real load-bearing structure of this meeting. Six dedicated ECR sessions in five days is not ornamentation; it is infrastructure. Preserve it.")
p_text(docB, "The pairing of three legacy sessions with six ECR sessions reads as a generational hand-off in the program structure. Future meetings can name that intention more explicitly — and could consider scheduling some pairs in adjacent slots, so attendees walk from one to the next.")
p_text(docB, "The Friday density signal suggests programming might use spacing — or hybrid options for parallel-clash relief. Anyone who has had to choose between three sessions they care about will tell you the cognitive cost.")
p_text(docB, "Bridge sessions matter even when small. EP013, WS05, WS08, and AV001 punch above their weight in the network. Future programs can make those bridges more visible — separate listings, cross-track signposting, dedicated time blocks — rather than treating them as one option among many.")
p_text(docB, "The geographic stake-vs-share gap is structural, not a one-meeting problem. Travel pathways, hybrid options, regional partnership programs — these are levers ASLO and SIL can pull between meetings, not only during them.")
...
p_text(docB, "It also shows a field that is not a single conversation. It is a network of overlapping ones, held together by lakes as connective vertebrae, by long-term monitoring as connective-tissue method, and by a handful of small but topologically important bridge sessions that route across the rest.")
...
PATH_B = PKG / "Freeman_OptionB_LongForm_v13.docx"
docB.save(str(PATH_B))
docB.save(str(BUNDLE / "05_OptionB_long_form_2100w.docx"))

# ===========================================================================
# OPTION A — Meeting Highlights candidate (short form v4)
# ===========================================================================
docA = Document()
...
PATH_A = PKG / "Freeman_MeetingHighlights_ASLO-SIL_2026_v5.docx"
docA.save(str(PATH_A))
docA.save(str(BUNDLE / "04_OptionA_short_form_900w.docx"))
...
# Inquiry email v10
# ===========================================================================
inquiry_v10 = """TO:       lobulletin-editor@aslo.org
...
ATTACHMENTS:
  ...
  4. 04_OptionA_short_form_900w.docx
     (Meeting Highlights candidate, ~900 words, opening visual + one figure)
...
I read the full programme before flying — 1,455 scheduled presentations across 308 session items, audited against the public schedule on 11 May 2026 — and the piece is organised around what the data says about us as a field, not only what the data is. A commissioned hand-drawn editorial illustration is attached as the opening visual: a watershed reading of the meeting, with one terracotta tributary tracing one molecule's journey from headwater to confluence.

A few of the load-bearing findings, each anchored to the underlying data:

  • The most visible method backbone in 2026 is not AI — it is long-term monitoring, the most-tagged single method (about 9% of talks) and the one that threads through about ten distinct problem clusters. AI and machine learning are present (about 2.4%) but spread thin: visible across many problems at low intensity in each. The program tells a story about patient, multi-decade observation as connective tissue, with AI being adopted on top of it.

  • Equity content is not in a silo. Indigenous-knowledge, equity, community-led, and citizen-science framings appear in 58 talks across 14 session items, and by betweenness centrality across a co-occurrence network of the program's tags they sit alongside rivers, estuaries, fisheries, food webs, and DOM as bridge topics — they connect otherwise-distinct sub-conversations. EP013 "Two-Eyed Seeing" is programmed as a science session, not an adjunct.
  ...
  • The community has, quietly, reached a gender-balance signal at both presenter and organiser levels: about 53% female-inferred among presenters and 56% among organisers, cautiously inferred from a European-biased name classifier that left about 12% of names unclassified.
...
The piece also includes a "Paths through the meeting" reader guide (microbial-DOM-biogeochemistry; long-term monitoring as research strategy; equity and community-led; cross-realm work; cold-and-dry systems) and a "What future organisers might take away" section (preserve the ECR scaffold; make bridge sessions more visible; address Friday density with spacing or hybrid options; treat the geographic gap as structural).

Both candidate drafts are attached so you can pick the format that fits the Bulletin:

  A · ~900-word Meeting Highlights with the opening visual and one data figure.
...
erika.freeman@igb-berlin.de  ·  ORCID 0000-0001-7161-6038
"""
(PKG / "presubmission_inquiry_email_v10.txt").write_text(inquiry_v10, encoding="utf-8")
(BUNDLE / "01_inquiry_email.txt").write_text(inquiry_v10, encoding="utf-8")

# ===========================================================================
# README
# ===========================================================================
readme = """SUBMISSION BUNDLE v4 — L&O Bulletin presubmission inquiry
==========================================================
...
Manuscript  : v12 long form / v4 short form
Inquiry     : v10
Hero image  : Concept A watershed (preserved from v3)

WHAT CHANGED SINCE BUNDLE v3
----------------------------
- The piece was restructured around audience-care questions instead of
  data categories. Subtitle (and orienting question) is now:
       "If this program is a mirror, what does it show we are becoming?"
- New top-level sections (Option B):
       What surprised me
       What's changing
       What we can feel proud of
       Where we are stretched
       Who is missing, and how we invite them in
       Paths through the meeting
       What future organisers might take away
       A closing thought
- Numbers are now in service of interpretation, not the structure of the
  piece. The standalone frame-distribution section was removed; its
  percentages live under "What surprised me" and elsewhere as evidence for
  specific claims.
- Inquiry email v10 leads with the mirror question and three interpretive
  findings, not with the percentages.
...
2. Attach all five files:
       ...
       04_OptionA_short_form_900w.docx
...
01_inquiry_email.txt                            Email body (v10).
...
04_OptionA_short_form_900w.docx                 Meeting Highlights candidate.
05_OptionB_long_form_2100w.docx                 Bulletin Article candidate.

WORD-COUNT RANGES (per L&O Bulletin guidelines)
-----------------------------------------------
   Meeting Highlights : 500-1,500 words   --> Option A (~900) fits cleanly.
   Bulletin Article   : 3,000-5,000 words --> Option B (~2,100) sits below
                                                the Article minimum. Either
                                                expand by ~1,000 words on
                                                request, or trim below 1,500
                                                to land in Meeting Highlights.

SOURCE FILES (reference, not for attachment)
--------------------------------------------
.../_GitHubRepo/aslo2026-conference-landscape/manuscripts/
    01_member_narrative_1500w_v12.md   (Option B source - current)
    02_meeting_highlights_500w_v4.md   (Option A source - current)
    VERSION_NOTES.md                   (audit trail through v12)

Build script:
.../_GitHubRepo/aslo2026-conference-landscape/scripts/17_build_submission_bundle_v4.py

Canonical archive:
.../_ConferenceLandscape/submission_package/
    Freeman_MeetingHighlights_ASLO-SIL_2026_v5.docx   (Option A)
    Freeman_OptionB_LongForm_v13.docx                 (Option B)
    presubmission_inquiry_email_v10.txt
...
print()
print("Option A docx total word count: {}".format(body_wc(BUNDLE / "04_OptionA_short_form_900w.docx")))

"""
Build submission_bundle_v9/ — new closing + no provenance descriptor.

Changes vs bundle v8 (manuscript v15 -> v16, short v7 -> v8):
  - Closing thought rewritten. Old "That seems worth showing up for." gone.
    New ending circles back to the opener and answers the subtitle:
    "The mirror is the prelude. The five days in Montreal are where we live it.
     See you in the rooms."
  - Watershed caption no longer claims hand-drawn provenance.
  - Inquiry email body says "An illustration is attached" (no "hand-drawn").
  - Manuscript formatting (Times New Roman 12pt, 1.5 spacing, line numbers,
    page numbers) preserved from v8 builder.

Outputs:
  G:\...\_ConferenceLandscape\submission_bundle_v9\
  G:\...\submission_package\Freeman_MeetingHighlights_ASLO-SIL_2026_v10.docx
  G:\...\submission_package\Freeman_OptionB_LongForm_v18.docx
  G:\...\submission_package\presubmission_inquiry_email_v14.txt
"""
...
BUNDLE = CONFLAND / "submission_bundle_v9"
...
# ===========================================================================
# Formatting helper (per saved memory: feedback_manuscript_docx_defaults.md)
# ===========================================================================
...
# No provenance claim — just the metaphor
WATERSHED_CAPTION = (
...
p_text(docB, "Read generously, the picture is of a community becoming more connected, more visible to itself, and clearer about where the next invitations should go. The mirror is the prelude. The five days in Montreal are where we live it.")
p = docB.add_paragraph()
p.add_run("See you in the rooms.").bold = True
...
PATH_B = PKG / "Freeman_OptionB_LongForm_v18.docx"
...
PATH_A = PKG / "Freeman_MeetingHighlights_ASLO-SIL_2026_v10.docx"
...
# ===========================================================================
# Inquiry email v14 — no provenance claim
# ===========================================================================
inquiry_v14 = """TO:       lobulletin-editor@aslo.org
...
ATTACHMENTS:
  1. 00_OpeningVisual_watershed.png
     (editorial illustration, opening visual)
...
erika.freeman@igb-berlin.de  ·  ORCID 0000-0001-7161-6038
"""
(PKG / "presubmission_inquiry_email_v14.txt").write_text(inquiry_v14, encoding="utf-8")
(BUNDLE / "01_inquiry_email.txt").write_text(inquiry_v14, encoding="utf-8")

# ===========================================================================
# README
# ===========================================================================
readme = """SUBMISSION BUNDLE v9  |  L&O Bulletin presubmission inquiry
============================================================
...
Manuscript  : v16 long form / v8 short form
Inquiry     : v14
Hero image  : watershed illustration (no provenance claim made anywhere)

WHAT CHANGED SINCE BUNDLE v8
----------------------------
- New closing thought. Old "That seems worth showing up for." is gone.
  New ending: "The mirror is the prelude. The five days in Montreal are
  where we live it. See you in the rooms." Returns to the opener and
  answers the subtitle.
- Watershed image carries no provenance claim of any kind. The caption
  ends on the metaphor; the bundle says nothing about how the image was
  made.
- Inquiry email body says "An illustration is attached" with no
  description of technique or production.
- Manuscript formatting (Times New Roman 12pt, 1.5 spacing, line numbers,
...
01_inquiry_email.txt                            Email body (v14).
...
Canonical archive (submission_package/):
    Freeman_MeetingHighlights_ASLO-SIL_2026_v10.docx   (Option A)
    Freeman_OptionB_LongForm_v18.docx                  (Option B)
    presubmission_inquiry_email_v14.txt

Build script:
.../_GitHubRepo/aslo2026-conference-landscape/scripts/22_build_submission_bundle_v9.py
"""
...
# ===========================================================================
EM = "—"
forbidden = [EM, "commission", "hand-drawn", "vertebrae", "country-detected",
             "backbone", "organised", "organiser", "visualisations"]
for label, p in [
    ...
    hits = []
    for w in forbidden:
        if w == EM and EM in text:
            hits.append("em dash")
        elif w != EM and w.lower() in text.lower():
            hits.append(w)

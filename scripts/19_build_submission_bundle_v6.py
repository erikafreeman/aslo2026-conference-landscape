"""
Build submission_bundle_v6/ — second editorial pass + organizer warmth.

What changed vs bundle v5 (manuscript v13 -> v14):
  - "backbone" replaced with neutral phrasing.
  - Gender sentence has "quietly" inserted: "shows, quietly, a strong gender-balance signal."
  - US spelling standardized (organised/organiser/visualisations -> organized/organizer/visualizations).
  - "Pretending otherwise" line removed from "Where we are stretched."
  - Organizer-takeaway section reframed as "What future programs can build on" with
    each item rewritten as a continuation rather than a fix.
  - "Who is missing" closes with a deeper-levers acknowledgment (authorship valuation,
    funding, language-of-publication) alongside the programmatic levers.
  - Opening-visual caption drops "commissioned" claim.
  - Short form (Option A v6) includes a compact "paths + future programs" paragraph.
  - Inquiry email v12 mirrors all of the above; drops "commissioned" from its body.

Outputs:
  G:\...\_ConferenceLandscape\submission_bundle_v6\
  G:\...\submission_package\Freeman_MeetingHighlights_ASLO-SIL_2026_v7.docx
  G:\...\submission_package\Freeman_OptionB_LongForm_v15.docx
  G:\...\submission_package\presubmission_inquiry_email_v12.txt
"""
...
BUNDLE = CONFLAND / "submission_bundle_v6"
...
# ===========================================================================
# OPTION B — Bulletin Article candidate (manuscript v14 long form)
# ===========================================================================
docB = Document()
...
PATH_A = PKG / "Freeman_MeetingHighlights_ASLO-SIL_2026_v7.docx"
...
# Inquiry email v12
# ===========================================================================
inquiry_v12 = """TO:       lobulletin-editor@aslo.org
...
erika.freeman@igb-berlin.de  ·  ORCID 0000-0001-7161-6038
"""
(PKG / "presubmission_inquiry_email_v12.txt").write_text(inquiry_v12, encoding="utf-8")
(BUNDLE / "01_inquiry_email.txt").write_text(inquiry_v12, encoding="utf-8")

# ===========================================================================
# README
# ===========================================================================
readme = """SUBMISSION BUNDLE v6 — L&O Bulletin presubmission inquiry
==========================================================
...
Manuscript  : v14 long form / v6 short form
Inquiry     : v12
Hero image  : Concept A watershed

WHAT CHANGED SINCE BUNDLE v5
----------------------------
Second editorial pass + organizer warmth:
- "Backbone" replaced; only watershed/mirror/network metaphors remain in body.
- Gender sentence softened: "The program shows, quietly, a strong gender-balance signal."
- US spelling standardized (organised/organiser/visualisations -> organized/organizer/visualizations).
- "Pretending otherwise" line removed from "Where we are stretched."
- Organizer-takeaway section renamed "What future programs can build on" and
  every item reframed as a continuation of what this meeting started, never
  as a fix or critique.
- "Who is missing" closes with both programmatic levers (hubs, hybrid, travel)
  and deeper levers (international authorship valuation, funding, language
  representation). "The shorter and the longer levers tend to move together."
- Opening-visual caption no longer claims "commissioned."
- Inquiry email v12 mirrors all of the above.
...
01_inquiry_email.txt                            Email body (v12).
...
-----------------------------------------------
   ...
   Bulletin Article   : 3,000-5,000 words --> Option B (~2,100) sits below
                                                ...
                                                expand on request, or trim
                                                below 1,500 to land in
                                                Meeting Highlights.

SOURCE FILES (reference, not for attachment)
--------------------------------------------
.../_GitHubRepo/aslo2026-conference-landscape/manuscripts/
    01_member_narrative_1500w_v14.md   (Option B source - current)
    02_meeting_highlights_500w_v6.md   (Option A source - current)
    VERSION_NOTES.md                   (audit trail through v14)

Build script:
.../_GitHubRepo/aslo2026-conference-landscape/scripts/19_build_submission_bundle_v6.py

Canonical archive:
.../_ConferenceLandscape/submission_package/
    Freeman_MeetingHighlights_ASLO-SIL_2026_v7.docx   (Option A)
    Freeman_OptionB_LongForm_v15.docx                 (Option B)
    presubmission_inquiry_email_v12.txt
...
# ===========================================================================
# Sanity check: no forbidden words remain
# ===========================================================================
forbidden = [
    "vertebrae", "country-detected", "backbone",
...
for label, p in [
    ...
    lower = text.lower()
    hits = [w for w in forbidden if w.lower() in lower]
    if hits:

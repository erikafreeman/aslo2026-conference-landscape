...
*Version note (v2): every assertion in v1 was audited against the underlying data. The "twenty years ago, ASLO session names were dominated by measure, describe, characterise" historical claim was removed (the comparison did not survive verification against archived ASLO program books from 2003, 2007, and 2010). "The field's methodological soul," "the marine-heavy ASLO of 2010," "the bets being placed will look obvious in five years," and several other speculative or character-claim sentences were also removed. The "FT-ICR-MS: 2 talks" line in v1 was an undercount from a title-only match; the audited number is 7 talks naming FT-ICR specifically and 14 using ultra-high-resolution MS more broadly. Session counts updated to 308 (was 309); presentation counts to 1,455 (was 1,461). All session codes referenced (EP001, EP004, EP012, AV001, EP010, EC02, EC03, EP011, EP006, EP013, WS05, WS08, SS050, SS070, SS049, SS041, SS048, SS079) cross-checked against the public schedule and confirmed.*

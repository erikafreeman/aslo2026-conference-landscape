...
*What 1,455 scheduled presentations reveal about aquatic science in 2026*
...
Freshwater science is a major center of gravity in this joint meeting. A keyword classifier on session names, session descriptions, and presentation titles (multi-label, so a single talk can carry more than one tag) produces the following frame distribution:
...
Methodologically, the most frequently-tagged approaches are long-term monitoring and time-series (about 9% of talks), hydrology and hydrodynamics (about 8%), and experimental mesocosms (about 3%).
...
The meeting is dense. 260 oral talks plus 230 posters land on Friday 15 May 2026 alone, close to 490 presentations in one day, the heaviest of the program.
